...
let recipeContainer = document.querySelector(".recipe-list");
...
function search() {
    ...
    // Swapped comparitors so ratings go from highest to lowest.
...
function recipeTemplate(recipe) {
    return `<article class="recipe-card">
                ...
                <div class="card-body">
                    <span class="tag">${tagTemplate(recipe.tags)}</span>
